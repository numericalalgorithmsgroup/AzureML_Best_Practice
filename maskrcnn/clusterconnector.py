...
class ClusterConnector:
    def __init__(
        ...
        self.logfile = "clusterlogs/{}_{}.log".format(self.workspace, tstr)
    ...
    def initialise(self, min_nodes=0, max_nodes=0, idle_timeout_secs=30):
    ...
    def _copy_nodefile_to_nodes(self):
        ...
        outputs = self._all_ssh.run_command(
            r'ifconfig ib0 | grep "inet addr" | cut -d: -f2',
            shell="bash -c",
        )
